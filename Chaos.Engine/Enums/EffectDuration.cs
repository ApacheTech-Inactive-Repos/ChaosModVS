...
namespace Chaos.Engine.Enums
{
    ...
    public enum EffectDuration
    {
        ...
        /// </summary>
        [Description("Long Duration Effect")]
        Long,

        /// <summary>
        ///     Represents an effect that, once started, will persist until the effect is manually shut down, or the game session ends.
        /// </summary>
